            ...
            <main className="flex-1 overflow-y-auto p-4 sm:p-8 bg-gray-50/50">
              <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="space-y-6">
                      {rentals.length > 0 ? (
                        <div className="grid gap-4">
                          {rentals.map(rental => (
                            <RentalCard key={rental.id} rental={rental} userRole="parent" onEdit={handleEditRental} onUpdate={handleUpdateRental} onPay={handlePayRental} />
                          ))}
                        </div>
                      ) : (
                  ...
                  {activeTab === 'profile' && (
                    <div className="bg-white p-8 rounded-2xl border border-gray-100 max-w-2xl shadow-sm">
                        ...
                        {profileStatus.message && (
                          <div className={`p-4 rounded-xl mb-6 flex items-center gap-3 text-sm ${
                            ...
                            <SafeIcon icon={profileStatus.type === 'success' ? FiCheckCircle : FiAlertCircle} className="text-lg" />
                            {profileStatus.message}
                          </div>
                        )}
                        ...
                        <form onSubmit={handleSaveProfile} className="space-y-5">
                            <div>
                                ...
                                <input 
                                  ...
                                  className="w-full p-3 border border-gray-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition-all" 
                                />
                            </div>
                            <div>
                            ...
                            <div className="pt-4 flex items-center justify-between border-t border-gray-100">
                                <button 
                                  ...
                                  className="bg-blue-600 text-white px-6 py-2.5 rounded-xl font-bold hover:bg-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                                >
                                  {profileSaving ? (
                                    <>
