/*
    ...
    */
    ...
    CREATE POLICY "Chat participants can view each other profiles" ON public.profiles FOR SELECT TO authenticated USING (
        ...
        EXISTS (
            ...
            WHERE
                ...
                OR
                (cm.receiver_id = auth.uid() AND cm.sender_id = profiles.id)
        )
    );